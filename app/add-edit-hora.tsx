...
export default function AddEditHora() {
  const user = useUser();
  ...
  const handleSave = async ({
    ...
    const memoryData: Partial<Status> = {
      title,
      image: image || "",
      userId: user.uid,
    };
    ...
    try {
      ...
      // await setDoc(doc(firestore, "memories", id), memoryData);

      await addDoc(collection(db, "Status-Warframe"), memoryData);
